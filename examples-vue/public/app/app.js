	    ...
	    component: {
	      ...
	      components: {
	        "home": function home(resolve) {
	          __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(9)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));});
	        }
	      }
	    }
	  },
	    ...
	    component: {
	      ...
	      components: {
	        "pageForm": function pageForm(resolve) {
	          __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(12)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));});
	        }
	      }
	    }
	  }
